...
namespace Saltr.UnitySdk
{
    ...
    public class SaltrConnector
    {
        ...
        private Action<NetworkWrapperResult> _onConnectSuccess;
        private Action<NetworkWrapperResult> _onConnectFail;
        ...
        public SaltrConnector(string clientKey, string deviceId, bool useCache)
        {
        ...
        public void Start()
        {
            ...
            {
                _activeFeatures = SLTDeserializer.DecodeFeatures(cachedAppData as Dictionary<string, object>);
                _experiments = SLTDeserializer.DecodeExperiments(cachedAppData as Dictionary<string, object>);
            }
            _isStarted = true;
        }
        ...
        /// </summary>
        /// <param name="onConnectSuccess">Success callback.</param>
        /// <param name="onConnectFail">Fail callback, receives <see cref="saltr.Status.SLTStatus"/> object as the first parameter.</param>
        ...
        public void Connect(Action<NetworkWrapperResult> onConnectSuccess, Action<NetworkWrapperResult> onConnectFail, SLTBasicProperties basicProperties, Dictionary<string, object> customProperties)
        {
            if (!_isStarted)
            {
            ...
            if (_isLoading)
            {
                onConnectFail(new NetworkWrapperResult(ExceptionConstants.SaltrAppDataLoadRefused));
                return;
            }
            ...
            HttpWrapper.Instance.Get(url, _onConnectSuccess, _onConnectFail);            
        }

        /// <summary>
        /// See <see cref="saltr.SLTUnity.Connect"/>.
        /// </summary>
        public void Connect(Action<NetworkWrapperResult> onConnectSuccess, Action<NetworkWrapperResult> onConnectFail, SLTBasicProperties basicProperties)
        {
            Connect(onConnectSuccess, onConnectFail, basicProperties, null);
        }

        /// <summary>
        /// See <see cref="saltr.SLTUnity.Connect"/>.
        /// </summary>
        public void Connect(Action<NetworkWrapperResult> onConnectSuccess, Action<NetworkWrapperResult> onConnectFail)
        {
            Connect(onConnectSuccess, onConnectFail, null);
        }

        //public void Load()
        //{
        //    HttpWrapper wrapper = (HttpWrapper)go.GetComponent(typeof(HttpWrapper));
        ...
        public string FillRequestPrameters(string url, Dictionary<string,string> parameters)
        {
            char seperator = '?';
